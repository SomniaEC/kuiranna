...
(function ($) {
    $.alert_ext = {
        ...
        // Balloon template
        tmpl: '<div class="alert alert-dismissable ${State}"><div class="icon">${Icon}</div><strong>${Title}</strong>${Content}<a class="close" data-dismiss="alert" aria-hidden="true">&times;</a></div>',
        ...
        create: function (msg) {
            ...
            this.alertDiv.appendTo($('.contenido'));
        },
        ...
        set_css: function () {
            ...
            if (pos[0] > -1 && pos[0] < 1) {
                pos[0] = pos[0] * $('.contenido').height();
            }
            if (pos[1] > -1 && pos[1] < 1) {
                pos[1] = pos[1] * $('.contenido').width();
            }
            ...
            for (var i in pos_str) {
                ...
                if ($.inArray(str, ['left', 'right']) > -1) {
                    ...
                    alertDiv.css({
                        'top': ($('.contenido').outerHeight() - alertDiv.outerHeight()) / 2 + pos[0] + ie6,
                        'left': ($('.contenido').outerWidth() - alertDiv.outerWidth()) / 2 + pos[1]
                    });
                }
            }
